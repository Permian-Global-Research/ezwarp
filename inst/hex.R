...
make_logo <- function(
  ...
  p_logo <- data.frame(text = "ezwarp", .x = 0, .y = 0) |>
    ...
    theme_void() +
    coord_fixed()
  ggsave(tf, p_logo, width = 180 * 3, height = 90 * 3, units = "mm")
  ...
  img <- image_read(hex_crop(tf2, border_size = 8, border_colour = "white"))
...
perm <- image_scale(
  image_read(
    "https://avatars.githubusercontent.com/u/106586419?s=400&u=69fb140fd7d3f204f361e85dba7398ac33d88a03&v=4"
  ),
  "x150"
)
# Standard is atop
